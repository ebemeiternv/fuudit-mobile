...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-accent/30 to-accent/50 overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-10 w-32 h-32 bg-accent/20 rounded-full blur-xl animate-float"></div>
        <div className="absolute bottom-32 right-16 w-24 h-24 bg-accent/20 rounded-full blur-lg animate-float" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-accent/15 rounded-full blur-md animate-float" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-5xl mx-auto animate-fade-in">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-primary font-medium mb-6">Your playful and smart kitchen assistant</p>
          ...
          <h2 className="text-5xl md:text-7xl font-bold text-foreground mb-6 text-balance">
            ...
            <span className="text-primary relative">
              ...
              <svg className="absolute -bottom-2 left-0 w-full h-3" viewBox="0 0 200 10" xmlns="http://www.w3.org/2000/svg">
                <path d="M0,7 Q50,2 100,7 T200,7" stroke="currentColor" strokeWidth="2" fill="none" className="text-muted-foreground" />
              </svg>
            </span>
          </h2>
